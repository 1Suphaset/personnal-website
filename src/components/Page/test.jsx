...
function Test() {
  ...
  useEffect(() => {
    ...
    const fetchData = () => {
      if (projectId === '1') {
        setData({
          info: ["front-end dev", "04/11/2024 - Now", "พีมิก,พี่เพลง"],
          image: En1,
        ...
        setData({
          info: ["Design", "18/11/2024-21/11/2024", "พี่แอ้ม,พี่ใหม่"],
          image: Ru3,
        ...
        setData({
          info: ["UX/UI", "01/11/2024-07/11/2024", "พี่ใหม่"],
          image: Ws4,
        ...
        setData({
          info: ["front-end dev", "13/11/2024", "พีมิก,พี่เพลง"],
          image: ST2,
